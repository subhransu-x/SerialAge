...
export const CARRIER_VERIFIED_FIXTURES: readonly DecoderTestCase[] = [
  ...
  {
    description: 'C-STYLE3-R1: Style 3 US — September 1984 (BIC example W4D14008)',
    manufacturerId: 'carrier',
    ...
    source: {
      ...
      notes: 'Style 3 US example. W=September, 4=1984.',
      confidence: 'verified',
    },
    notes: 'Real BIC Style 3 US example. W=September per verified BIC mapping.',
  },
  {
    description: 'C-STYLE3-R2: Style 3 Canada — September 1984 (BIC example 4WD14008)',
    manufacturerId: 'carrier',
    ...
    source: {
      ...
      url: 'https://building-center.org',
      dateReviewed: '2026-09-09',
      notes: 'Style 3 CA example. 4=1984, W=September.',
      confidence: 'verified',
    },
...
export const CARRIER_SYNTHETIC_FIXTURES: readonly DecoderTestCase[] = [
  ...
  {
    description: 'C-STYLE3-S3: Style 3 US — August 1984 (V)',
    manufacturerId: 'carrier',
    serialNumber: 'V4A12345',
    expectedStatus: 'success',
    expectedFormatId: 'carrier-style3-us',
    expectedYear: 1984,
    expectedMonth: 8,
    ...
    expectedProductType: 'unknown',
    source: null,
    notes: 'Synthetic. V=August.',
  },
  {
    description: 'C-STYLE3-S4: Style 3 US — September 1984 (W)',
    manufacturerId: 'carrier',
    serialNumber: 'W4A12345',
    expectedStatus: 'success',
    expectedFormatId: 'carrier-style3-us',
    expectedYear: 1984,
    expectedMonth: 9,
    ...
    expectedProductType: 'unknown',
    source: null,
    notes: 'Synthetic. W=September.',
  },
  {
    description: 'C-STYLE3-S5: Style 3 US — October 1984 (X)',
    manufacturerId: 'carrier',
    serialNumber: 'X4A12345',
    expectedStatus: 'success',
    expectedFormatId: 'carrier-style3-us',
    expectedYear: 1984,
    expectedMonth: 10,
    ...
    expectedProductType: 'unknown',
    source: null,
    notes: 'Synthetic. X=October.',
  },
  {
    description: 'C-STYLE3-S6: Style 3 US — November 1984 (Y)',
    manufacturerId: 'carrier',
    serialNumber: 'Y4A12345',
    expectedStatus: 'success',
    expectedFormatId: 'carrier-style3-us',
    expectedYear: 1984,
    expectedMonth: 11,
...
export const CARRIER_UNSUPPORTED_FIXTURES: readonly DecoderTestCase[] = [
  ...
  {
    description: 'C-UNS-05: Style 3 with skipped letter O — O4A12345',
    manufacturerId: 'carrier',
    serialNumber: 'O4A12345',
    expectedStatus: 'unsupported',
    expectedFormatId: null,
    expectedYear: null,
    expectedMonth: null,
    ...
    expectedProductType: null,
    source: null,
    notes: 'Synthetic. Letter O is skipped in Style 3.',
  },
  {
    description: 'C-UNS-06: Style 3 with skipped letter U — U4A12345',
    manufacturerId: 'carrier',
    serialNumber: 'U4A12345',
    expectedStatus: 'unsupported',
    expectedFormatId: null,
    expectedYear: null,
    expectedMonth: null,
    ...
    expectedProductType: null,
    source: null,
    notes: 'Synthetic. Letter U is skipped in Style 3.',
  },
];
