...
// ---------------------------------------------------------------------------
// Primary sources — used by all supported Ruud formats
// ---------------------------------------------------------------------------
...
const BIC_SOURCE: SourceReference = {
  ...
  notes:
    'Industry reference database for HVAC age identification. Documents Ruud (Rheem) serial formats ' +
...
const PICK_HVAC_SOURCE: SourceReference = {
  ...
  dateReviewed: '2026-08-27',
  notes:
    'HVAC technician guide. Corroborates the 10-character modern Ruud format ' +
...
export const RUUD_STANDARD_10_SOURCES: readonly SourceReference[] = [
  BIC_SOURCE,
  PICK_HVAC_SOURCE,
] as const;

/** Sources for ruud-embedded-plant (older embedded plant-code formats) */
export const RUUD_EMBEDDED_PLANT_SOURCES: readonly SourceReference[] = [
  BIC_SOURCE,
] as const;
